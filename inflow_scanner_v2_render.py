...
QUIET_BARS = 6          # строго 6 баров затишья перед импульсом
...
FIB_RETRACE = 0.0      # 0.0 = вход рыночным ордером сразу на закрытии сигнальной свечи, без ретеста
ENTRY_TTL_BARS = 0      # не используется при маркет-входе (оставлено для совместимости)
FEE_MAKER = 0.0002
FEE_TAKER = 0.00055
