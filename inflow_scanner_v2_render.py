...
TF = "15m"
VOL_MA_LEN = 20
VOL_SPIKE_MIN = 1.4     # ужесточено: без входов на слабом/фейковом объёмном всплеске
...
OI_MIN_GROW = 0.005      # OI-ПОДТВЕРЖДЕНИЕ: (OI_now - OI_prev)/OI_prev < 2% -> сигнал отбрасывается (фейковый объём без реального интереса)
RSI_LEN = 14
